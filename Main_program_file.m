...
while( round <=20)
    ...
    [bs1,sensor_x1,sensor_y1,circle_nodes1,dist1] = UDCP_greedy_techniqueCenter( x_co,y_co,radius);
   ...
   ett = ett1./charging_time;
    ...
    [bs11,sensor_x11,sensor_y11,circle_nodes11,dist11] = UDCP_greedy_techniqueWeight( x_co,y_co,radius);
